# <a name="using-change-notifications-and-track-changes-with-microsoft-graph"></a>Usar notificaciones de cambios y realizar un seguimiento de los cambios con Microsoft Graph
